    ...
    return (
        <>
            ...
            >
                ...
                <td>
                    <p className="text-muted mb-0">Last Minute Sales Event</p>
                </td>
                <td>
                    <p className="fw-normal mb-1">Available Tickets</p>
                    <p className="text-muted mb-0">{concert.Total_Available}</p>
                </td>
                <td>
                    <p className="fw-normal mb-1">Ticket Sold</p>
                    <p className="text-muted mb-0">{concert.Total_Sold}</p>
                </td>
                <td>
                    <div className="border border-dark border-2 container-fluid h-auto bg-danger rounded">
                        <p className="fw-normal mb-1">No. of ticket</p>
                        <p className="text-dark mb-0">Sold in the last</p>
                        <p className="fw-normal mb-1">No. of days</p>
                    </div>
                </td>
                <td>
